...
class TestAdaptiveEngine(unittest.TestCase):
    ...
    def test_remedial_under_40(self):
        res = {"class_level": 10, "chapter": "Electricity", "percentage": 35, "difficulty": "medium"}
    ...
    def test_step_up_from_medium(self):
        res = {"class_level": 10, "chapter": "Electricity", "percentage": 80, "difficulty": "medium"}
        cfg = get_next_quiz_config(res)
    ...
    def test_syllabus_mastery(self):
        res = {"class_level": 10, "chapter": "Our Environment", "percentage": 95, "difficulty": "hard"}
        cfg = get_next_quiz_config(res)
