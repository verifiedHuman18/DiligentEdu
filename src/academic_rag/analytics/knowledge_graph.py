                ...
                if raw_concept:
                    try:
                        ...
                        if isinstance(parsed, list):
                            target_concepts = [str(item).strip() for item in parsed if str(item).strip()]
...
def get_chapter_knowledge_graph(
    ...
    for doc in student_docs:
        ...
        if not doc_ch or doc_ch == "All Chapters" or doc_ch.lower() in ch_title.lower() or ch_title.lower() in doc_ch.lower():
