...
def test_gemini_api_key(
    ...
    try:
        ...
        if "429" in err_msg or "quota" in err_msg or "resource_exhausted" in err_msg:
            return False, "API key quota exhausted (HTTP 429). Please verify your Google AI Studio quota."
        if "401" in err_msg or "403" in err_msg or "invalid" in err_msg or "unauthorized" in err_msg:
            return False, "Invalid API key or unauthorized (HTTP 401/403). Please verify the key string."
