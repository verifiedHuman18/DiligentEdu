...
from backend.scholarships.qa import ask_scholarship_question as run_ask_question
from backend.scholarships.scraper import NSPCatalogueScraper
from backend.scholarships.search import search_scholarships as run_search_scholarships
...
def search_scholarships(
    ...
    from backend.scholarships.search import ScholarshipSearchEngine
...
def ask_question(
    ...
    store = storage or _default_storage
    from backend.scholarships.qa import ScholarshipQAEngine
