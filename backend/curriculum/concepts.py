...
CHAPTER_CONCEPTS_REGISTRY: Dict[str, Dict[str, Any]] = {
        ...
        "edges": [
            {
                ...
                "target": "tissue_permanent_plant",
                "relationship": "derived_from",
            },
            {
                "source": "tissue_meristematic",
                "target": "tissue_animal_epithelial_muscular",
                "relationship": "related",
            },
            {
                "source": "tissue_animal_epithelial_muscular",
                "target": "tissue_connective_nervous",
                "relationship": "prerequisite",
            },
            {
                "source": "tissue_permanent_plant",
                "target": "tissue_connective_nervous",
                "relationship": "related",
            },
        ],
    ...
    "Real Numbers": {
        ...
        "edges": [
            {
                "source": "math10_euclid_fundamental",
                "target": "math10_irrational_proofs",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_euclid_fundamental",
                "target": "math10_decimal_expansions",
                "relationship": "prerequisite",
            },
        ],
    },
    "Polynomials": {
        ...
        "edges": [
            {
                "source": "math10_poly_zeros_geom",
                "target": "math10_poly_coeff_relations",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_poly_coeff_relations",
                "target": "math10_poly_division_alg",
                "relationship": "derived_from",
            },
        ],
    },
    "Pair of Linear Equations in Two Variables": {
        ...
        "edges": [
            {
                "source": "math10_linear_graphical",
                "target": "math10_linear_substitution",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_linear_substitution",
                "target": "math10_linear_reducible",
                "relationship": "related",
            },
        ],
    },
    "Quadratic Equations": {
        ...
        "edges": [
            {
                "source": "math10_quad_standard_factorisation",
                "target": "math10_quad_formula",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_quad_formula",
                "target": "math10_quad_nature_roots",
                "relationship": "derived_from",
            },
        ],
    },
    "Arithmetic Progressions": {
        ...
        "edges": [
            {
                "source": "math10_ap_definition_common_diff",
                "target": "math10_ap_nth_term",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_ap_nth_term",
                "target": "math10_ap_sum_terms",
                "relationship": "derived_from",
            },
        ],
    },
    "Triangles": {
        ...
        "edges": [
            {
                "source": "math10_tri_similar_figures_bpt",
                "target": "math10_tri_similarity_criteria",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_tri_similarity_criteria",
                "target": "math10_tri_areas_pythagoras",
                "relationship": "derived_from",
            },
        ],
    },
    "Coordinate Geometry": {
        ...
        "edges": [
            {
                "source": "math10_coord_distance_formula",
                "target": "math10_coord_section_formula",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_coord_section_formula",
                "target": "math10_coord_area_triangle",
                "relationship": "related",
            },
        ],
    },
    "Introduction to Trigonometry": {
        ...
        "edges": [
            {
                "source": "math10_trig_ratios_def",
                "target": "math10_trig_specific_angles",
                "relationship": "prerequisite",
            },
            {
                "source": "math10_trig_specific_angles",
                "target": "math10_trig_identities",
                "relationship": "derived_from",
            },
        ],
    },
    "Some Applications of Trigonometry": {
        ...
        "edges": [
            {
                "source": "math10_trig_app_elevation_depression",
                "target": "math10_trig_app_heights_distances",
                "relationship": "prerequisite",
            },
        ],
    },
    "Circles": {
        ...
        "edges": [
            {
                "source": "math10_circ_tangent_radius_perp",
                "target": "math10_circ_tangents_external_point",
                "relationship": "prerequisite",
            },
        ],
    },
    "Areas Related to Circles": {
        ...
        "edges": [
            {
                "source": "math10_area_circ_sector_segment",
                "target": "math10_area_circ_plane_combinations",
                "relationship": "derived_from",
            },
        ],
    },
    "Surface Areas and Volumes": {
        ...
        "edges": [
            {
                "source": "math10_sa_volume_combination_solids",
                "target": "math10_sa_volume_conversion_solids",
                "relationship": "related",
            },
        ],
    },
    "Statistics": {
        ...
        "edges": [
            {
                "source": "math10_stat_mean_grouped",
                "target": "math10_stat_mode_grouped",
                "relationship": "related",
            },
            {
                "source": "math10_stat_mode_grouped",
                "target": "math10_stat_median_grouped",
                "relationship": "related",
            },
        ],
    },
    "Probability": {
        ...
        "edges": [
            {
                "source": "math10_prob_classical_definition",
                "target": "math10_prob_complementary_experiments",
                "relationship": "prerequisite",
            },
        ],
    },
    ...
    "Orienting Yourself: The Use of Coordinates": {
        ...
        "edges": [
            {
                "source": "math9_coord_cartesian_system",
                "target": "math9_coord_plotting_interpreting",
                "relationship": "prerequisite",
            },
        ],
    },
    "Introduction to Linear Polynomials": {
        ...
        "edges": [
            {
                "source": "math9_poly_terms_coefficients",
                "target": "math9_poly_zeroes_linear_graphs",
                "relationship": "prerequisite",
            },
        ],
    },
    "The World of Numbers": {
        ...
        "edges": [
            {
                "source": "math9_num_real_number_types",
                "target": "math9_num_line_and_exponents",
                "relationship": "prerequisite",
            },
        ],
    },
    "Exploring Algebraic Identities": {
        ...
        "edges": [
            {
                "source": "math9_alg_square_identities",
                "target": "math9_alg_cubic_factor_identities",
                "relationship": "derived_from",
            },
        ],
    },
    "I'm Up and Down, and Round and Round": {
        ...
        "edges": [
            {
                "source": "math9_geom_lines_angles_parallel",
                "target": "math9_geom_triangles_congruence",
                "relationship": "prerequisite",
            },
        ],
    },
    "Measuring Space: Perimeter and Area": {
        ...
        "edges": [
            {
                "source": "math9_mens_heron_formula",
                "target": "math9_mens_surface_volume_basics",
                "relationship": "related",
            },
        ],
    },
