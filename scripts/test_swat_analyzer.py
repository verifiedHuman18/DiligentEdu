...
def run_swat_tests():
    ...
    record_quiz_attempt(
        ...
        {f"q_choice_{i}": "A" if i <= 21 else "B" for i in range(1, 26)},
    )  # 21/25 = 84%
    ...
    record_quiz_attempt(
        student_id,
        {
            ...
            "questions": [
                {
                    "question_id": f"light_{i}",
                    "question": f"Light Q{i}",
                    "correct_answer": "A",
                    "source_pages": [1],
                }
                for i in range(1, 22)
        ...
        {f"q_choice_{i}": "A" if i <= 17 else "B" for i in range(1, 22)},
    )  # 17/21 = 81.0%
    ...
    record_quiz_attempt(
        ...
        {f"q_choice_{i}": "A" if i <= 13 else "B" for i in range(1, 21)},
    )  # 13/20 = 65.0%
    ...
    record_quiz_attempt(
        student_id,
        {
            ...
            "questions": [
                {
                    "question_id": f"carb_{i}",
                    "question": f"Carbon Q{i}",
                    "correct_answer": "A",
                    "source_pages": [1],
                }
                for i in range(1, 19)
        ...
        {f"q_choice_{i}": "A" if i <= 11 else "B" for i in range(1, 19)},
    )  # 11/18 = 61.1%
    ...
    record_quiz_attempt(
        student_id,
        {
            ...
            "questions": [
                {
                    "question_id": f"mag_{i}",
                    "question": f"Magnetic Q{i}",
                    "correct_answer": "A",
                    "source_pages": [1],
                }
                for i in range(1, 26)
        ...
        {f"q_choice_{i}": "A" if i <= 12 else "B" for i in range(1, 26)},
    )  # 12/25 = 48.0%
    ...
    record_quiz_attempt(
        student_id,
        {
            ...
            "questions": [
                {
                    "question_id": f"elec_{i}",
                    "question": f"Electricity Q{i}",
                    "correct_answer": "A",
                    "source_pages": [1],
                }
                for i in range(1, 51)
        ...
        {f"q_choice_{i}": "A" if i <= 21 else "B" for i in range(1, 51)},
    )  # 21/50 = 42.0%
    ...
    print(
        f"Questions Attempted: {swat['questions_attempted']} (Correct: {swat['questions_correct']})"
    )
