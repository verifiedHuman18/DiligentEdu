...
from swat_analyzer import get_student_swat, format_swat_report, STRONG_THRESHOLD, AVERAGE_THRESHOLD
...
def run_tests():
    ...
    print(f"✓ Overall Stats Verified: Average={swat['overall']['average']}%, Accuracy={swat['overall']['accuracy']}%")
    ...
    print(f"✓ Trend Verified: {swat['trend']['direction']} (Earlier: {swat['trend']['earlier_average']}%, Recent: {swat['trend']['recent_average']}%)")
