...
from adaptive_engine import get_next_quiz_config, get_chapter_sequence, get_next_chapter
...
def run_tests():
    ...
    print(f"Result: {cfg1['action']} -> Difficulty: {cfg1['difficulty']} | Chapter: {cfg1['chapter']}")
    ...
    print(f"Result: {cfg2['action']} -> Difficulty: {cfg2['difficulty']} | Chapter: {cfg2['chapter']}")
    ...
    print(f"Result: {cfg3['action']} -> Difficulty: {cfg3['difficulty']} | Chapter: {cfg3['chapter']}")
    ...
    print(f"Result: {cfg4['action']} -> Difficulty: {cfg4['difficulty']} | Chapter: {cfg4['chapter']}")
    ...
    res5 = {"class_level": 9, "chapter": "Cell: The Building Block of Life", "percentage": 90, "difficulty": "hard"}
    cfg5 = get_next_quiz_config(res5)
    print(f"Result: {cfg5['action']} -> Difficulty: {cfg5['difficulty']} | Chapter: {cfg5['chapter']}")
    ...
    print(f"Result: {cfg6['action']} -> Difficulty: {cfg6['difficulty']} | Chapter: {cfg6['chapter']}")
